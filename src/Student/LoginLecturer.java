 ...
 * @author aliff
 */
public class LoginLecturer extends javax.swing.JFrame {

    /**
     * Creates new form loginlecturer
     */
    ...
    private void initComponents() {
        ...
        button4.setForeground(new java.awt.Color(54, 67, 252));
        button4.setText("Sign Up");
        button4.setColorClick(new java.awt.Color(199, 199, 199));
        button4.setColorOver(new java.awt.Color(239, 240, 241));
        ...
        jPanel1.add(button4);
        button4.setBounds(910, 580, 100, 30);
        ...
        button2.setColorClick(new java.awt.Color(199, 199, 199));
        button2.setColorOver(new java.awt.Color(239, 240, 241));
        button2.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        jPanel1.add(button2);
        button2.setBounds(420, 568, 200, 50);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/Log-in [Lecturer].png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginLecturer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginLecturer().setVisible(true);
            }
        });
    }
